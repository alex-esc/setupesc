...
# Keybinds-release by alex-esc

This is my main script, all updates will be pushed directly to my github repository, all past versions are discontinued (v1,2,3,4 & 5), written on Auto Hotkey under the GPLv3.
...
Some features not fully developed or realized are also available on my github under the folder called ahk-experiments, these are separate files not included here, such features include shortcuts for thunderbird, firefox, gpoder and other programs like launchy.
